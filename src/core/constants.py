...
# Mangan payouts (simplified)
MANGAN_DEALER_TSUMO_PAYMENT_EACH: int = 2000  # from each of 3 players
MANGAN_NON_DEALER_TSUMO_DEALER_PAYMENT: int = 2000
MANGAN_NON_DEALER_TSUMO_OTHERS_PAYMENT: int = 1000
